...
public abstract class WordModel {	
	...
	private final Set<String> stopwordSet = new HashSet<String>();
	private static HashMap<String, Set<String>> stopWordStemmedSetPerStemmer = new HashMap<String, Set<String>>();
	...
	final public boolean isStopword(String word) {//optimized for lower-case words
		if(word.isEmpty())
			return true;
		if(word.charAt(0) >= '0' && word.charAt(0) <= '9')
			return true;
		if(stopwordSet.contains(stem(word)))
			return true;
		return false;
	}
